    ...
    <div class="bg-gray-900">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-white text-sm text-center sm:text-left site-info">
                <a href="<?php echo esc_url(__('https://wordpress.org/', 'leonardo-vite')); ?>">
                    <?php
                    /* translators: %s: CMS name, i.e. WordPress. */
                    printf(esc_html__('Proudly powered by %s', 'leonardo-vite'), 'WordPress');
                    ?>
                </a>
                <span class="sep"> | </span>
                <?php
                /* translators: 1: Theme name, 2: Theme author. */
                printf(esc_html__('Theme: %1$s by %2$s.', 'leonardo-vite'), 'leonardo-vite', '<a href="https://profiles.wordpress.org/lazarus9/">Lazar</a>');
                ?>
            </p><!-- .site-info -->
